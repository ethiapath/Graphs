...
def explore(direction, prevRoomId):
    ...
    for e in currentRoom.getExits():
        # print(currentRoom.id)
        # print(maze_map[currentRoom.id])
        # print(e, maze_map[currentRoom.id].__contains__(e))
        if maze_map[currentRoom.id].__contains__(e) and maze_map[currentRoom.id][e] == '?':
